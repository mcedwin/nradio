...
(function($){
  ...
  Plugin.prototype = {
    ...
    next: function($btn)
    {
      ...
      (self.currentTrack === miplaylist.length - 1)
        ? track = 0
        : track = self.currentTrack + 1;
    ...
    changeTrack: function(index)
    {
      ...
      self.domAudio.src  = miplaylist[index].file;
    ...
    {
      var self          = this,
          track         = miplaylist[self.currentTrack],
          file          = track.file,
          thumb         = track.thumb,
    ...
    {
      var self = this,
          thumb = miplaylist[self.currentTrack].thumb,
          styles = {
