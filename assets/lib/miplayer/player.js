var player = {
  ...
  init: () => {
    ...
    player.pAud.ontimeupdate = () => {
      ...
      player.hTimeN.innerHTML = player.nicetime(
        Math.floor(player.pAud.currentTime)
      );
    };
  ...
  load: (song, preload) => {
    ...
    player.pAud.oncanplaythrough = () => {
      ...
      player.hTimeT.innerHTML = player.nicetime(
        Math.floor(player.pAud.duration)
      );
      ...
      player.hVolI.onclick = () => {
        ...
        player.hVolI.className =
          player.pAud.volume == 0 ? "icon-volume-mute2" : "icon-volume-high";
      };
