...
$(document).ready(function() {
    ...
    var $dt = $('#mitabla'),
        conf = {
            ...
            onrow: function(data) {
                ...
                <a class="btn btn-success edit btn-sm" href="{baseurl}/admin/usuario/editar/{id}"><i class="fas fa-edit"></i></a>
                <a class="btn btn-danger delete btn-sm" href="{baseurl}/admin/usuario/borrar/{id}"><i class="fas fa-trash-alt"></i></a></td>
                </div>`;
    ...
    $(document).on('click', '.edit', function() {
        $(this).mydialog(function(dlg) { }, () => $table.draw())
        return false;
    });
