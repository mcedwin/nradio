...
class Biografias extends BaseController
{
  use BaseGaleria;
  protected $model;
  ...
  public $imagebase = 'static/images/biografias/';
  public $imagebaseImagenes = 'static/images/imagenes/';

  public function __construct()
  {
    $this->model = new GeneralModel('biografias');
  ...
  public function guardar($id = '')
  {
    ...
    $this->dieMsg(true, '', base_url('admin/biografias'));
  }
  ...
  public function crear()
  {
    ...
    $this->addJs(array(
      ...
      'js/admin/biografias/form.js',
    ));
    $datos['id'] = '0';
    $datos['titulo'] = 'Nueva biografía';
