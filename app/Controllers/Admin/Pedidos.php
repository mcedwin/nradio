...
class Pedidos extends BaseController
{
  ...
  {
    $this->model = new GeneralModel('pedidos');
  }
  ...
  public function index()
  {
    ...
    $columns = array(
      ...
      array('db' => 'motivo', 'dt' => 'Motivo', "field" => "motivo"),
      array('db' => 'email', 'dt' => 'Email', "field" => "email"),
      array('db' => 'pais', 'dt' => 'País', "field" => "pais"),
      array('db' => 'detalle', 'dt' => 'Detalle', "field" => "detalle"),
      array('db' => 'fecha', 'dt' => 'Fecha', "field" => "fecha",'formatter'=>fn($d,$row)=>date("d-m-Y h:i a",$row["fecha"])),
