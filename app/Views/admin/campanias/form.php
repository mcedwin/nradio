...
<div class="container">
  ...
  <form class="form-horizontal needs-validation"  id="formContent" action="<?= base_url("admin/campanias/guardar/" . $id) ?>" method="post" enctype="multipart/form-data" novalidate>

    <div class="row">
      <?php
      echo myinput($fields->titulo, '12');
      echo myinput($fields->fecha, '6');
      echo myinput($fields->hora, '6');
