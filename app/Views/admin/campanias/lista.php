<div class="container-fluid cont-title d-flex justify-content-between">
    <div class="cont-title-text">Campañas</div>
    <a href="<?php echo base_url('admin/campanias/crear') ?>" class="btn btn-sm btn-success new"><i class="fa-solid fa-plus"></i> Campaña</a>
</div>
