<div class="container-fluid cont-title d-flex justify-content-between">
    <div class="cont-title-text">Usuarios</div>
    <a href="<?php echo base_url('admin/usuario/crear') ?>" class="btn btn-sm btn-success new"><i class="fa-solid fa-plus"></i> Usuario</a>
</div>
<div class="container-fluid">
    <form class="ocform form-horizontal">
        <div class="row">
            ...
            <div class="col-sm-3">
                <?php echo myselect('tipo', '', '* Tipo', $utipos); ?>
            </div>
            <div class="col-sm-5">
