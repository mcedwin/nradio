<div class="container-fluid cont-title d-flex justify-content-between">
    <div class="cont-title-text">Programas</div>
    <a href="<?php echo base_url('admin/programas/crear') ?>" class="btn btn-sm btn-success new"><i class="fa-solid fa-plus"></i> Programa</a>
</div>
