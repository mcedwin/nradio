<div class="container-fluid cont-title d-flex justify-content-between">
    <div class="cont-title-text">Noticias</div>
    <a href="<?php echo base_url('admin/noticias/crear') ?>" class="btn btn-sm btn-success new"><i class="fa-solid fa-plus"></i> Noticia</a>
</div>
