<div class="container-fluid cont-title d-flex justify-content-between">
    <div class="cont-title-text">Testimonios</div>
    <a href="<?php echo base_url('admin/testimonios/crear') ?>" class="btn btn-sm btn-success new"><i class="fa-solid fa-plus"></i> Testimonio</a>
</div>
        ...
        <div class="row">
            <div class="col-sm-2 pt-2">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="1" name="activo" id="checkactivo">
