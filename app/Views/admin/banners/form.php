<div class="modal-dialog modal-md">
  <div class="modal-content">
    <form class="form-horizontal needs-validation" action="<?= base_url("admin/banners/guardar/" . $id) ?>" method="post" enctype="multipart/form-data" novalidate>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          echo myinput($fields->subTitulo, '12');
          echo myinput($fields->detalle, '12');
          echo myinput($fields->url, '12');
          ?>
          <div class="d-none">
            <?php
